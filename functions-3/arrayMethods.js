...
// CODE HERE
const salesTax = orders.map(object => object.price * (object.tax + 1));
...
// CODE HERE
const bobsTotal = purchases.filter(object => object.owner === "Bob").reduce((total,object) => total + object.price,0)
